...
namespace TravelingApp
{
    public class SlidingTabScrollView : HorizontalScrollView
    {
        ...
        public SlidingTabScrollView(Context context, IAttributeSet attrs, int defaultStyle) : base(context, attrs, defaultStyle)
        {
            ...
            //Make sure the tb strips fill the view
            FillViewport = true;
            ...
            this.AddView(mTabStrip, LayoutParams.MatchParent, LayoutParams.MatchParent); //Match parents horizontally and vertically
